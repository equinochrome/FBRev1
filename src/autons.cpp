...
chassis.moveToPose( 8.75, -48.75, 120, 2000, {.forwards = false, .lead = .25, .minSpeed = 110});
pros::delay(1050);
Mogo.set_value(true);
pros::delay(175);
Hook.move(-127);
...
chassis.setPose(-53,-57, -90);
// Get mogo and drive back
chassis.moveToPose( -8.75, -48.475, -120, 2000, {.forwards = false, .lead = .25, .minSpeed = 110});
pros::delay(1050);
Mogo.set_value(true);
pros::delay(175);
Hook.move(-127);
